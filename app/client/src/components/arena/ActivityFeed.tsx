// Live scrolling feed of arena events - collapsible
  ...
  return (
    <div className="bg-[var(--color-bg-secondary)] rounded-lg border border-[var(--color-bg-tertiary)]">
      ...
      <button
        ...
        className="w-full flex items-center gap-2 px-4 py-3 hover:bg-[var(--color-bg-tertiary)] transition-colors rounded-t-lg"
      >
